...
class SliceBlock(nn.Module):
    """Recurrent block: MLA attention + SliceMoE FFN."""
    def __init__(self, model_dim, n_heads, head_dim, mla_latent_dim, slice_dim, expert_hidden):
        super().__init__()
        self.norm1 = RMSNorm(model_dim)
        self.attn  = MLASelfAttention(model_dim, n_heads, head_dim, mla_latent_dim)
        self.norm2 = RMSNorm(model_dim)
